...
def model_random_forest(X_train2, y_train2, X_test2, y_test2):
...
def model_bagging_DT(X_train2, y_train2, X_test2, y_test2): #F1: 0.73
...
def model_bagging_RF(X_train2, y_train2, X_test2, y_test2): #F1: 0.77
...
def model_grad_boost(X_train2, y_train2, X_test2, y_test2): #0.63
...
def model_ada_boost(X_train2, y_train2, X_test2, y_test2):
...
def model_DT(X_train2, y_train2, X_test2, y_test2):
    clf = DecisionTreeClassifier(random_state = 0).fit(X_train2,y_train2)
    
    y_predicted = clf.predict(X_test2)
    DT_accuracy = accuracy_score(y_test2, y_predicted)
    DT_f1 = f1_score(y_test2, y_predicted, average="weighted")
...
if __name__ == "__main__":
    ...
    DT_accuracy, DT_f1 = model_DT(X_train2, y_train2, X_test2, y_test2)
    ...
    print("decision tree model: Acc, F1:", DT_accuracy, DT_f1, '\n')
